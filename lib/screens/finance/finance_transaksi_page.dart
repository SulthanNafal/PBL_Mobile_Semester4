                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => FinanceTransaksiDetailPage(transaksi: trx),
                        ),
                      );
                      _fetchTransaksi();
                    },
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              if (trx['bukti_bayar'] != null)
                                Row(
                                  children: [
                                    Icon(Icons.image_outlined, size: 14, color: Colors.green.shade600),
                                    const SizedBox(width: 4),
                                    Text('Ada bukti bayar', style: TextStyle(fontSize: 11, color: Colors.green.shade600, fontWeight: FontWeight.w500)),
                                  ],
                                ),
                            ],
                          ),
                          if (status == 'menunggu konfirmasi') ...[
                            ...
                            Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.touch_app_outlined, size: 14, color: Colors.orange.shade700),
                                  const SizedBox(width: 4),
                                  Text('Tap untuk konfirmasi pembayaran', style: TextStyle(fontSize: 11, color: Colors.orange.shade700, fontWeight: FontWeight.w500)),
                                ],
                              ),
                            ),
                          ],
                          if (status == 'refund diajukan') ...[
                            ...
                            Container(
                              ...
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Icon(Icons.replay_outlined, size: 14, color: Colors.teal.shade700),
                                  const SizedBox(width: 4),
                                  Text('User mengajukan refund', style: TextStyle(fontSize: 11, color: Colors.teal.shade700, fontWeight: FontWeight.w500)),
                                ],
                              ),
                            ),
                          ],
